...
router.delete("/unfollow-follow-id", auth(), followerController.unfollowByFollowId);
...
router.get("/friends", auth(), followerController.getMyAllFriends);
router.get("/follower-request", auth(), followerController.getMyAllFollowerRequest);
router.get("/following-request", auth(), followerController.getMyAllFollowingRequest);
router.get("/suggested-user", auth(), followerController.getAllSuggestedUsers);
